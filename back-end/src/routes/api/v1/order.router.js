...
router.get('/get-profit', AuthMiddleware.verifyToken, AuthMiddleware.verifyRole(['admin']), OrderController.getProfitByMonth);
router.get('/get-all-profits', AuthMiddleware.verifyToken, AuthMiddleware.verifyRole(['admin']), OrderController.getAllProfitsByYear);
router.get('/export-profits', AuthMiddleware.verifyToken, AuthMiddleware.verifyRole(['admin']), OrderController.exportProfitsByYear);
