    ...
    */
    ...
    addProduct = async (req, res, next) => {
        try {
            ...
            const { name, description, brand, category, specs, inStock, price, cost, isAvailable } = req.body;
            const newProduct = await ProductService.addProduct(name, description, brand, category, specs, inStock, price, cost, isAvailable, imageFiles);
            res.json({
                success: true,
    ...
    updateProduct = async (req, res, next) => {
        try {
            ...
            const { name, description, brand, category, specs, inStock, price, cost, isAvailable } = req.body;
            const newProductData = await ProductService.updateProduct(productId, name, description, brand, category, specs, inStock, price, cost, isAvailable, imageFiles);
            res.json({
                success: true,
